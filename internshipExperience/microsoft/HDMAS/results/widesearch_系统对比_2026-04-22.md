...
> 对比日期：2026-04-22（v2，已加入 HDMAS_COPILOT_8a）
...
| **HDMAS_COPILOT_8a** | `HDMAS_COPILOT/batch_results/test_0417_copilot_en100_8agents` | **124** | 118 | 100 | **24** | 8-agent，**ZH 仅 24/100** |
...
| HDMAS_COPILOT_8a *(ZH 未跑完)* | 200 | 76 | 0.060 | 0.348 | 0.479 |

8a 全集偏低是因为 76 题 ZH 没跑，**不能据此评判 8a 弱**。
...
HDMAS_v4 的 ZH SR 仅 0.030，是 3a 的 1/3.7、BARE 的 1/3。
...
| HDMAS_COPILOT_8a | 118 | 0.102 | 0.590 | 0.811 |
...
| HDMAS_COPILOT_8a | 95 | 0.116 | 0.551 | **0.807** |
...
| HDMAS_COPILOT_8a *(n=23 太小)* | 23 | 0.044 | **0.749** | 0.832 |
...
### 1. HDMAS_COPILOT_3a 仍是综合最强

所有口径、EN/ZH 子集、严格交集，3a 的 SR 都不弱于其它三家。
